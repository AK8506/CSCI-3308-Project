...
INSERT INTO reviews 
    (username, review, date_posted, rating, snow_quality, lift_infrastructure, difficulty)
    VALUES 
    (
        'test1', 'Pretty good test run here at this mountain', '2022-07-22', 4.5, 4.0, 4.0, 3.5
    ),
    (
        'test2', 'I love this place', '2023-01-04', 5.0, 5.0, 5.0, 5.0
    ),
    (
        'test1', 'Not much snow unfortunately', '2023-05-04', 2.5, 1.5, 2.0, 1.5
    );
...
INSERT INTO mountains
    ...
    VALUES
    (
        'TestMT', 'Testing City', 45, -116, 3.5, 12000, 'https://t4.ftcdn.net/jpg/01/30/24/67/360_F_130246761_XVWbg4AGgGu7SlcKi2QPR23J03U710mP.jpg', 0, 0,0
    ),
    (
        'TestMT2', 'Testing City2', 36.01, -106.7, 4.2, 15000, 'https://t4.ftcdn.net/jpg/01/30/24/67/360_F_130246761_XVWbg4AGgGu7SlcKi2QPR23J03U710mP.jpg', 0, 0,0
    ),
    (
